	...
	public class Program
	{
		...
		public static bool FieldsTagsPublishFormatTest()
		{
			try
			{
				...
				obj.SetSensorResult(new SensorResult() {Value = (object)value });
				SensorLocation sensorLocation = new SensorLocation() { Area = "area1", Location = "location1" };
